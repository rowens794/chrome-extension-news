...
/* harmony import */ var _google_generative_ai__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @google/generative-ai */ "./node_modules/@google/generative-ai/dist/index.mjs");
...
function isArticle() {
  ...
  const articleExists = (0,_mozilla_readability__WEBPACK_IMPORTED_MODULE_0__.isProbablyReaderable)(document);
...
const getGeneratedSummary = async (prompt, googleApiKey) => {
  return new Promise(async (resolve, reject) => {
    const genAI = new _google_generative_ai__WEBPACK_IMPORTED_MODULE_1__.GoogleGenerativeAI(googleApiKey);
    ...
    const safetySettings = [
      {
        ...
        threshold: _google_generative_ai__WEBPACK_IMPORTED_MODULE_1__.HarmBlockThreshold.BLOCK_NONE,
      },
      {
...
async function processDocument() {
  ...
  const reader = new _mozilla_readability__WEBPACK_IMPORTED_MODULE_0__.Readability(docClone);
